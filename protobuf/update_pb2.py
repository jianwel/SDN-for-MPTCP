...
_FLOW = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='jsonData', full_name='sdn.Flow.jsonData', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REPORT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='flow', full_name='sdn.Report.flow', index=2,
...
_REPORT.fields_by_name['flow'].message_type = _FLOW
...
class Flow(_message.Message):
  ...
  # @@protoc_insertion_point(class_scope:sdn.Flow)
